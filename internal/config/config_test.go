...
func validEnvironment(t *testing.T) {
	...
	t.Setenv("OIDC_CLIENT_ID", "contract-management-dev-web")
	t.Setenv("OIDC_CLIENT_SECRET", "test-client-secret")
	t.Setenv("OIDC_REDIRECT_URI", "http://localhost:8081/contract-management/auth/callback")
	...
	t.Setenv("APP_PUBLIC_URL", "http://localhost:8081/contract-management/")
	t.Setenv("APP_PATH_PREFIX", "/contract-management")
