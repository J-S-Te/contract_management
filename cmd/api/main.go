...
func main() {
	...
	service := &application.Service{Repo: repository, Templates: repository, Temporal: temporalClient, TaskQueue: cfg.TemporalTaskQueue, NodeTimeout: cfg.NodeTimeout, ReminderInterval: cfg.ReminderInterval}
